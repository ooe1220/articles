...
```bash
/opt/simulide-110sr0/simulide not.sim1
```

- a=0 時、出力が1となりLEDが光る
<img width="1193" height="504" alt="0" src="https://github.com/user-attachments/assets/d44624f6-5926-407c-a106-80c682775132" />


- a=1 時、出力が0となりLEDは光らない
<img width="1193" height="504" alt="1" src="https://github.com/user-attachments/assets/00840b59-625e-4e15-bbc4-97b75affdae6" />
...
<item itemtype="Fixed Voltage" CircId="Fixed Voltage-1" mainComp="false" Show_id="false" Show_Val="false" Pos="52,-4" rotation="0" hflip="1" vflip="1" label="Fixed Voltage-1" idLabPos="-64,-24" labelrot="0" valLabPos="-16,8" valLabRot="0" Voltage="5 V" Out="false" />
...
<item itemtype="Resistor" CircId="Resistor-18" mainComp="false" ShowProp="Resistance" Show_id="false" Show_Val="true" Pos="96,-48" rotation="0" hflip="1" vflip="1" label="Resistor-18" idLabPos="-16,-24" labelrot="0" valLabPos="-16,6" valLabRot="0" Resistance="70 Ω" />

<item itemtype="Led" CircId="Led-19" mainComp="false" Show_id="false" Show_Val="false" Pos="140,-48" rotation="0" hflip="1" vflip="1" label="Led-19" idLabPos="-16,-24" labelrot="0" valLabPos="-16,20" valLabRot="0" Color="Yellow" Grounded="false" Threshold="2.4 V" MaxCurrent="30 mA" Resistance="0.6 Ω" />

<item itemtype="Ground" CircId="Ground-21" mainComp="false" Show_id="false" Show_Val="false" Pos="164,-16" rotation="0" hflip="1" vflip="1" label="Ground-21" idLabPos="-16,8" labelrot="0" valLabPos="-16,20" valLabRot="0" />

<item itemtype="Node" CircId="Node-13" mainComp="false" Pos="88,-4" />

<item itemtype="Node" CircId="Node-22" mainComp="false" Pos="80,-4" />
...
<item itemtype="Connector" uid="Connector-31" startpinid="And Gate-4-in1" endpinid="Node-13-0" pointList="88,0,88,-4" />

<item itemtype="Connector" uid="Connector-32" startpinid="Node-13-2" endpinid="And Gate-4-in0" pointList="88,-4,88,-8" />

<item itemtype="Connector" uid="Connector-33" startpinid="Resistor-18-rPin" endpinid="Led-19-lPin" pointList="112,-48,124,-48" />

<item itemtype="Connector" uid="Connector-35" startpinid="Led-19-rPin" endpinid="Ground-21-Gnd" pointList="156,-48,164,-48,164,-32" />

<item itemtype="Connector" uid="Connector-36" startpinid="Resistor-18-lPin" endpinid="Node-22-1" pointList="80,-48,80,-4" />

<item itemtype="Connector" uid="Connector-37" startpinid="Fixed Voltage-1-outnod" endpinid="Node-22-0" pointList="68,-4,80,-4" />

<item itemtype="Connector" uid="Connector-38" startpinid="Node-22-2" endpinid="Node-13-1" pointList="80,-4,88,-4" />
