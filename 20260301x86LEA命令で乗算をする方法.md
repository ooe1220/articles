...
コンパイル通る
```
lea edx, dword [edx+1*edx]
lea edx, dword [edx+2*edx]
lea edx, dword [edx+3*edx]
lea edx, dword [edx+4*edx]
lea edx, dword [edx+7*edx]
lea edx, dword [edx+8*edx]
```

コンパイル通らない
```
lea edx, dword [edx+5*edx] 
lea edx, dword [edx+6*edx]
lea edx, dword [edx+9*edx]
```
...
```
test@test-fujitsu:~/kaihatsu$ objdump -d -M intel test.o
...
00000000 <_start>:
   0:	ba 03 00 00 00       	mov    edx,0x3
   5:	8d 14 12             	lea    edx,[edx+edx*1]
   8:	8d 14 52             	lea    edx,[edx+edx*2]
   b:	8d 14 95 00 00 00 00 	lea    edx,[edx*4+0x0]
  12:	8d 14 92             	lea    edx,[edx+edx*4]
  15:	8d 14 d5 00 00 00 00 	lea    edx,[edx*8+0x0]
  1c:	8d 14 d2             	lea    edx,[edx+edx*8]
  1f:	cd 03                	int    0x3
  21:	b8 01 00 00 00       	mov    eax,0x1
  26:	bb 00 00 00 00       	mov    ebx,0x0
  2b:	cd 80                	int    0x80
```
