...
今回は語尾が`HI`及び`LS`の`ADD`命令を使ってみます。
他の命令になっても語尾の意味は変わらないので一番単純な`ADD`だけ試します。

# 検証

```main.c
extern int addhils_test(unsigned int a);
...
void main(void)
{
    ...
    putchar('\n');
    println("ADD TEST:");
    println("<=10: ADD 100"); // 百の位:結果　一と十の位:入力した数
    println(">10 : ADD 200");
    
    res = addhils_test((unsigned int)9);
    print("RES = ");
    print_dec(res);
    res=0;
    putchar('\n');
    
    res = addhils_test((unsigned int)10);
    print("RES = ");
    print_dec(res);
    res=0;
    putchar('\n');
    
    res = addhils_test((unsigned int)11);
    print("RES = ");
    print_dec(res);
    putchar('\n');
...
<img width="4096" height="3072" alt="28af4e2c4626b" src="https://github.com/user-attachments/assets/203591d9-2dea-41bb-9fef-8218d9256283" />
