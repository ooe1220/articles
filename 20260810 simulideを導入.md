...
別のディレクトリから起動する場合は以下のコマンド
```bash
/opt/simulide-110sr0/simulide
```
LEDが光った。諦めていたが、Z80の実験をする為にかなり調べた。
<img width="1249" height="509" alt="截图 2026-09-23 20-07-50" src="https://github.com/user-attachments/assets/00fe7750-8c52-4109-aed0-126e769d2b87" />
